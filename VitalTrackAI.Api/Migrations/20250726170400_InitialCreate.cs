        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReferenceMinResult = table.Column<double>(type: "double precision", nullable: false),
                    ReferenceMaxResult = table.Column<double>(type: "double precision", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DailyCaloriesIntake = table.Column<int>(type: "integer", nullable: false),
                    ...
                    SubjectiveMood = table.Column<int>(type: "integer", nullable: false),
                    Steps = table.Column<int>(type: "integer", nullable: true),
                    DailyHealthNotes = table.Column<string>(type: "text", nullable: false),
                    UserId = table.Column<string>(type: "text", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DailyMeasures", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DailyMeasures_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MenstrualCycleEntries", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MenstrualCycleEntries_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ResultLabel = table.Column<string>(type: "text", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MedicalTestResults_MeasureTypes_MeasureTypeId",
                        column: x => x.MeasureTypeId,
                        principalTable: "MeasureTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MedicalTestResults_MedicalTests_MedicalTestId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DailyMeasures_UserId",
                table: "DailyMeasures",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_MedicalTestResults_MeasureTypeId",
                table: "MedicalTestResults",
                column: "MeasureTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_MedicalTestResults_MedicalTestId",
                table: "MedicalTestResults",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MenstrualCycleEntries_UserId",
                table: "MenstrualCycleEntries",
                column: "UserId");
